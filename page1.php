...
if(isset($_POST['Uploadbutton']))//koympi 'epilogh arxeioy har'
{

  
  $json = file_get_contents('php://input');//kanoyme to input na dexete mono har files
  $json_decode = json_decode($json); //kanoyme decode to json arxeio
...
//ta koympia gia to 'anevasma arxeioy ston server' kai 'topikh apothiskefsi ' leitoyrgoyn me to arxeio 'FileReader.js' kai to arxeio 'uploadFile.php'
